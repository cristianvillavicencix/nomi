...
Nomi CRM is free and open-source. A public demo of the upstream project is at <https://marmelab.com/atomic-crm-demo>.
...
- ✉️ **Capture Emails**: CC Nomi CRM to automatically save communications as notes.
...
You can then access the app via [http://localhost:5174/](http://localhost:5174/). You will be prompted to create the first user.
...
Nomi CRM components are published as a Shadcn Registry file:
