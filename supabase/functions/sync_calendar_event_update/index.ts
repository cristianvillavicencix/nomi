...
import { syncCalendarEventBookingAfterUpdate } from "../_shared/syncCalendarEventUpdate.ts";
      ...
      try {
        ...
        if (
          ...
          return createErrorResponse(
            403,
            "You cannot sync calendar bookings",
          );
        }
        ...
        const result = await syncCalendarEventBookingAfterUpdate(supabaseAdmin, {
          orgId: member.org_id,
          calendarEventId,
        ...
        console.error("sync_calendar_event_update.error", error);
        return createErrorResponse(
          500,
