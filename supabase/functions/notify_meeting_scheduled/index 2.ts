...
import { notifyMeetingScheduled } from "../_shared/notifyMeeting.ts";
  ...
  OptionsMiddleware(async (req) => {
    ...
    return UserMiddleware(req, async (req, user) => {
      ...
      try {
        ...
        const result = await notifyMeetingScheduled(supabaseAdmin, {
          orgId: member.org_id,
          calendarEventId,
        ...
        console.error("notify_meeting_scheduled.error", error);
        return createErrorResponse(
          500,
