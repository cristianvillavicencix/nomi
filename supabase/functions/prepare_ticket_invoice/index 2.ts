...
import { prepareTicketInvoiceDraft } from "../_shared/ticketInvoiceFlow.ts";
  ...
  OptionsMiddleware(async (req) => {
    ...
    return UserMiddleware(req, async (req, user) => {
      ...
      try {
        ...
        const result = await prepareTicketInvoiceDraft(supabaseAdmin, {
          orgId: member.org_id,
          ticketId,
        ...
        console.error("prepare_ticket_invoice.error", error);
