...
import { prepareCombinedTicketInvoiceDraft } from "../_shared/combinedTicketInvoiceFlow.ts";
  ...
  OptionsMiddleware(async (req) => {
    ...
    return UserMiddleware(req, async (req, user) => {
      ...
      try {
        ...
        const result = await prepareCombinedTicketInvoiceDraft(supabaseAdmin, {
          orgId: member.org_id,
          ticketIds,
        ...
        console.error("prepare_combined_ticket_invoice.error", error);
