-- Restore contact display-name columns dropped when contacts_summary was recreated
-- for assigned_member_ids (20260710150000). Frontend search/sort may reference
-- full_name or name on contacts_summary.
