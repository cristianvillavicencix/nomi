...
alter table public.organization_members drop constraint if exists sales_org_id_fkey;
...
-- deals
alter table public.deals drop constraint if exists deals_org_id_fkey;
alter table public.deals
  add constraint deals_org_id_fkey
  foreign key (org_id) references public.organizations(id) on delete cascade;

-- contact_notes
alter table public.contact_notes drop constraint if exists contact_notes_org_id_fkey;
alter table public.contact_notes
  add constraint contact_notes_org_id_fkey
  foreign key (org_id) references public.organizations(id) on delete cascade;

-- deal_notes
alter table public.deal_notes drop constraint if exists deal_notes_org_id_fkey;
...
-- tags
alter table public.tags drop constraint if exists tags_org_id_fkey;
