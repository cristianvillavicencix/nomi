-- Align stale sweep with Phase 2 worker timeout (180s) + callback retry headroom.
...
comment on function public.fail_stale_website_audits(integer) is
  'Marks stuck website_audits as failed. Scheduled every 5 minutes (240s grace, Phase 2).';
