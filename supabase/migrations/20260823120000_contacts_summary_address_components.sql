-- Restore contact address component columns on contacts_summary.
-- They exist on public.contacts (20260615180000) but were dropped when the view
-- was recreated for assigned_member_ids and display-name fixes.
...
comment on view public.contacts_summary is
  'Contact list/detail read model including mailing address components.';
