import type { ProposalDeckPresetId } from "@/lbs/proposals/document/proposalTemplateSectionPresets";
...
export const PROPOSAL_INTRO_PREAMBLES: Record<ProposalDeckPresetId, IntroLocalePair> =
  {
    "website-contractor": {
