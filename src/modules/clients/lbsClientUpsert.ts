...
} from "@/modules/clients/clientContextLinks";
import { splitClientFullName } from "@/modules/clients/clientFormUtils";
import {
...
import type { ClientChannelFormValue } from "@/modules/clients/clientChannels";
...
export const hasPrimaryContactDraft = (
  values: Pick<
    import("@/modules/clients/ClientCreateForm").ClientCreateFormValues,
