...
import type { Conversation, LbsDeal, OrganizationMember } from "@/modules/types";
import { useOpenDirectMessage } from "@/modules/messages/useDirectMessage";
import {
  buildAssignedProjectDealIdSet,
  collectCoworkerMemberIdsFromDeals,
  shouldScopeMessagingToAssignedProjects,
} from "@/modules/messages/scopedMessaging";
