...
export const TimeEntriesForm = () => {
  ...
  const lunchMinutes = useWatch({ name: "lunch_minutes" }) as
    | number
    | undefined;
  ...
  useEffect(() => {
    ...
    if (effectiveDayState === "day_off" || isPresenceOnlyDay) {
      ...
      setValue(
        "worked_hours_raw",
        calculatedHours + effectiveLunchMinutes / 60,
      );
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <SelectInput
        source="day_type"
        choices={dayTypeChoices}
        defaultValue="worked_day"
        helperText={false}
        disabled={disabled}
      />
      <SelectInput
      ...
      <NumberInput
        source="worked_hours_raw"
        helperText={false}
        disabled={disabled}
      />
      <NumberInput
        source="payable_hours"
        helperText={false}
        disabled={disabled}
      />
      <NumberInput
