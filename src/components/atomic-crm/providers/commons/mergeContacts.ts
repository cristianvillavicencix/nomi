...
export const mergeContacts = async (
  ...
  const winnerUpdate = dataProvider.update<Contact>("contacts", {
    ...
    data: {
      ...
      address: winnerContact.address ?? loserContact.address,
      city: winnerContact.city ?? loserContact.city,
      state_abbr: winnerContact.state_abbr ?? loserContact.state_abbr,
      zipcode: winnerContact.zipcode ?? loserContact.zipcode,
      country: winnerContact.country ?? loserContact.country,
      ...
      organization_member_id:
        winnerContact.organization_member_id ??
        loserContact.organization_member_id,
