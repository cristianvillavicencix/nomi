              ...
              <div>
                <nav className="flex">
                  ...
                  <NavigationDropdown
                    ...
                    items={[
                      { label: "Employees", to: "/people?type=employee" },
                      { label: "Salespeople", to: "/people?type=salesperson" },
                      {
                        label: "Subcontractors",
                        to: "/people?type=subcontractor",
                      },
                    ]}
                  />
                  <NavigationTab
                    label="Hours"
                    to="/time_entries"
                    isActive={currentPath === "/time_entries"}
                  />
                  <NavigationTab
                    label="Payments"
                    to="/payments"
                  ...
                  <NavigationDropdown
                    ...
                    items={[
                      ...
                      {
                        label: "Labor Cost by Person",
                        to: "/reports/labor-cost-by-person",
                      },
                      {
...
const NavigationDropdown = ({
  ...
  <DropdownMenu>
    <DropdownMenuTrigger className={`px-6 py-3 text-sm font-medium transition-colors border-b-2 ${
      isActive
        ? "text-secondary-foreground border-secondary-foreground"
        : "text-secondary-foreground/70 border-transparent hover:text-secondary-foreground/80"
    }`}>
